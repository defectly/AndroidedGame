package local.def.heroes.oopSrc.heroBundle;
...
public abstract class Hero {
    ...
    public local.def.heroes.oopSrc.heroBundle.BattleTypes.BattleType BattleType;
    public int Range;
    public int Priority;
    public int Damage;
    public int Health;
    ...
    public void Step(List<Hero> mates, List<Hero> enemies) {
        ...
        int[] nextPosition = NextPosition(Position, enemy.Position);
    ...
    protected static Hero GetNearestEnemy(int[] selfPosition, List<Hero> enemies)
    {
        ...
        for (Hero enemy : enemies) {
            ...
            float distance = GetDistance(selfPosition, enemy.Position);
    ...
    {
        int[] difference = GetPositionDifference(selfPosition, enemyPosition);
